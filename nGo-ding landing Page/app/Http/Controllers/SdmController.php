    ...
    public function index(Request $request)
{
    ...
    return view('sdm.dashboard', compact('countLakiLaki', 'countPerempuan', 'years', 'countSimpanan'));
}
...
return view('sdm.detail_angsuran', compact('angsuran'));
...
public function showdetailprib($id)
{
    ...
    if ($anggota) {
        return view('sdm/detail_pribadi', compact('anggota'));
    } else {
...
public function biasa()
{
    ...
    return view('sdm.PeminjamanBiasa', ['anggotaData' => $anggotaData]);
}
...
public function khusus()
{
    $no_anggota = Auth::guard('anggota')->user()->no_anggota;
    $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
    return view('sdm.PeminjamanKhusus', ['anggotaData' => $anggotaData]);
}
public function status_prib()
{
    ...
    return view('sdm.status', ['pinjaman' => $pinjaman]);
}
...
public function ketuapinjam(Request $request)
{
    ...
    // Return a response
    return redirect()->route('sdm.status')->with('success', 'Peminjaman Berhasil diajukan.');
}
...
public function urgent()
{
    $no_anggota = Auth::guard('anggota')->user()->no_anggota;
    $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
    return view('sdm.PeminjamanUrgent', ['anggotaData' => $anggotaData]);
}
public function showshimpananprib($id)
{
    ...
    if ($data) {
        ...
        return view('sdm/detail_simp_prib', compact('data', 'monthlySavings'));
    }
...
public function data_pribadi()
{
    if (auth()->guard('anggota')->check()) {
        ...
        return view('/sdm/data_pribadi', ['anggotaData' => $anggotaData]);
    }
...
public function show($id)
    ...
    return view('sdm.detail_PeminjamanBiasa', compact('pinjaman'));

    ...
    public function index(Request $request)
{
    ...
    return view('pengawas.dashboard', compact('countLakiLaki', 'countPerempuan', 'years', 'countSimpanan'));
}
public function showdetailangsuran($id)
{
    ...
    return view('pengawas.detail_angsuran', compact('angsuran'));
...
public function data_pribadi()
{
    if (auth()->guard('anggota')->check()) {
        ...
        return view('/pengawas/data_pribadi', ['anggotaData' => $anggotaData]);
    }
...
return view('pengawas.detail_PeminjamanBiasa', compact('pinjaman'));
...
public function showdetailprib($id)
{
    ...
    if ($anggota) {
        return view('pengawas/detail_pribadi', compact('anggota'));
    } else {
...
public function showshimpananprib($id)
{
    ...
    if ($data) {
        ...
        return view('pengawas/detail_simp_prib', compact('data', 'monthlySavings'));
    }
...
public function biasa()
{
    ...
    return view('pengawas.PeminjamanBiasa', ['anggotaData' => $anggotaData]);
}
...
public function khusus()
{
    $no_anggota = Auth::guard('anggota')->user()->no_anggota;
    $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
    return view('pengawas.PeminjamanKhusus', ['anggotaData' => $anggotaData]);
}
...
public function urgent()
{
    $no_anggota = Auth::guard('anggota')->user()->no_anggota;
    $anggotaData = Anggota::where('no_anggota', $no_anggota)->get();
    return view('pengawas.PeminjamanUrgent', ['anggotaData' => $anggotaData]);
}
...
public function ketuapinjam(Request $request)
{
    ...
    // Return a response
    return redirect()->route('pengawas.status')->with('success', 'Peminjaman Berhasil diajukan.');
}
public function status_prib()
{
    ...
    return view('pengawas.status', ['pinjaman' => $pinjaman]);
}
...
public function DataAnggota(Request $request)
{
    ...
    return view('/pengawas/data_anggota', ['anggotaData' => $anggotaData]);
}
}
